"""
Django settings for RotuPrinters project.
"""
import os
...
ROOT_URLCONF = 'rotuprinters.urls'
...
WSGI_APPLICATION = 'rotuprinters.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'users.authentication.QueryParamJWTAuthentication',
    ),
...
# Tax Configuration
ISV_TAX_RATE = 0.15  # 15% ISV (Impuesto Sobre Ventas)
